...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_03_Social_06_FactorEmployeeReduceTest : Service_Legalios_Example_SocialTest
    {
        ...
        public Service_Legalios_Example_03_Social_06_FactorEmployeeReduceTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //03_Social_06_FactorEmployeeReduce
            LogTestExamples("03_Social_06_FactorEmployeeReduce.txt", _tests);
#endif
        }
        [Theory]
        [MemberData(nameof(TestData))]
        public void GetBundle_ShouldReturnValid_FactorEmployeeReduce(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
        {
            ...
            testResult.IfRight(r => r.SocialProps.FactorEmployeeReduce.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
