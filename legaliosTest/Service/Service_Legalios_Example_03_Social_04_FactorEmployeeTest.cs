...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_03_Social_04_FactorEmployeeTest : Service_Legalios_Example_SocialTest
    {
        ...
        public Service_Legalios_Example_03_Social_04_FactorEmployeeTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //03_Social_04_FactorEmployee
            LogTestExamples("03_Social_04_FactorEmployee.txt", _tests);
#endif
        }
        [Theory]
        ...
        public void GetBundle_ShouldReturnValid_FactorEmployee(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
        {
            ...
            testResult.IfRight(r => r.SocialProps.FactorEmployee.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
