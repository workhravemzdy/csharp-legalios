...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_14_MaxAmountOfTaxBonusTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_14_MaxAmountOfTaxBonusTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_14_MaxAmountOfTaxBonus
            LogTestExamples("04_Taxing_14_MaxAmountOfTaxBonus.txt", _tests);
#endif
        }
        [Theory]
        ...
        public void GetBundle_ShouldReturnValid_MaxAmountOfTaxBonus(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
        {
            ...
            testResult.IfRight(r => r.TaxingProps.MaxAmountOfTaxBonus.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
