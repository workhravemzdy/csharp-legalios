...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_01_Health_01_MinMonthlyBasisTest : Service_Legalios_Example_HealthTest
    {
        ...
        public Service_Legalios_Example_01_Health_01_MinMonthlyBasisTest()
        {
            _sut = new ServiceLegalios();

#if __PROTOKOL_TEST_FILE__
            //01_Health_01_MinMonthlyBasis
            LogTestExamples("01_Health_01_MinMonthlyBasis.txt", _tests);
#endif
        }
        [Theory]
        [MemberData(nameof(TestData))]
        public void GetBundle_ShouldReturnValid_MinMonthlyBasis(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
        {
            ...
            testResult.Value.HealthProps.MinMonthlyBasis.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName);
        }
    }
}
