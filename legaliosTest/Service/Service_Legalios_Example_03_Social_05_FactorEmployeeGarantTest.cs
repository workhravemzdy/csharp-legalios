...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_03_Social_05_FactorEmployeeGarantTest : Service_Legalios_Example_SocialTest
    {
        ...
        private static readonly TestDecScenario[] _tests = new TestDecScenario[]
        {
            ...
            new TestDecScenario("2013", new TestDecParams[] {
                ...
                new TestDecParams( "2013-2", 2013, 2, 2013, 2, 5.0m ),
                new TestDecParams( "2013-3", 2013, 3, 2013, 3, 5.0m ),
                new TestDecParams( "2013-4", 2013, 4, 2013, 4, 5.0m ),
                new TestDecParams( "2013-5", 2013, 5, 2013, 5, 5.0m ),
                new TestDecParams( "2013-6", 2013, 6, 2013, 6, 5.0m ),
                new TestDecParams( "2013-7", 2013, 7, 2013, 7, 5.0m ),
                new TestDecParams( "2013-8", 2013, 8, 2013, 8, 5.0m ),
                new TestDecParams( "2013-9", 2013, 9, 2013, 9, 5.0m ),
                new TestDecParams( "2013-10", 2013, 10, 2013, 10, 5.0m ),
                new TestDecParams( "2013-11", 2013, 11, 2013, 11, 5.0m ),
                new TestDecParams( "2013-12", 2013, 12, 2013, 12, 5.0m ),
            }),
            new TestDecScenario("2014", new TestDecParams[] {
                new TestDecParams( "2014-1", 2014, 1, 2014, 1, 5.0m ),
                new TestDecParams( "2014-2", 2014, 2, 2014, 2, 5.0m ),
                new TestDecParams( "2014-3", 2014, 3, 2014, 3, 5.0m ),
                new TestDecParams( "2014-4", 2014, 4, 2014, 4, 5.0m ),
                new TestDecParams( "2014-5", 2014, 5, 2014, 5, 5.0m ),
                new TestDecParams( "2014-6", 2014, 6, 2014, 6, 5.0m ),
                new TestDecParams( "2014-7", 2014, 7, 2014, 7, 5.0m ),
                new TestDecParams( "2014-8", 2014, 8, 2014, 8, 5.0m ),
                new TestDecParams( "2014-9", 2014, 9, 2014, 9, 5.0m ),
                new TestDecParams( "2014-10", 2014, 10, 2014, 10, 5.0m ),
                new TestDecParams( "2014-11", 2014, 11, 2014, 11, 5.0m ),
                new TestDecParams( "2014-12", 2014, 12, 2014, 12, 5.0m ),
            }),
            new TestDecScenario("2015", new TestDecParams[] {
                new TestDecParams( "2015-1", 2015, 1, 2015, 1, 5.0m ),
                new TestDecParams( "2015-2", 2015, 2, 2015, 2, 5.0m ),
                new TestDecParams( "2015-3", 2015, 3, 2015, 3, 5.0m ),
                new TestDecParams( "2015-4", 2015, 4, 2015, 4, 5.0m ),
                new TestDecParams( "2015-5", 2015, 5, 2015, 5, 5.0m ),
                new TestDecParams( "2015-6", 2015, 6, 2015, 6, 5.0m ),
                new TestDecParams( "2015-7", 2015, 7, 2015, 7, 5.0m ),
                new TestDecParams( "2015-8", 2015, 8, 2015, 8, 5.0m ),
                new TestDecParams( "2015-9", 2015, 9, 2015, 9, 5.0m ),
                new TestDecParams( "2015-10", 2015, 10, 2015, 10, 5.0m ),
                new TestDecParams( "2015-11", 2015, 11, 2015, 11, 5.0m ),
                new TestDecParams( "2015-12", 2015, 12, 2015, 12, 5.0m ),
            }),
        ...
        public Service_Legalios_Example_03_Social_05_FactorEmployeeGarantTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //03_Social_05_FactorEmployeeGarant
            LogTestExamples("03_Social_05_FactorEmployeeGarant.txt", _tests);
#endif
        }
        [Theory]
        [MemberData(nameof(TestData))]
        public void GetBundle_ShouldReturnValid_FactorEmployeeGarant(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
        {
            ...
            testResult.IfRight(r => r.SocialProps.FactorEmployeeGarant.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
