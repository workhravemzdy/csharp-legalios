...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_01_Health_02_MaxAnnualsBasisTest : Service_Legalios_Example_HealthTest
    {
        ...
        private static readonly TestIntScenario[] _tests = new TestIntScenario[] {
            ...
            new TestIntScenario("2012", new TestIntParams[] {
                new TestIntParams( "2012-1", 2012, 1, 2012, 1, 1809864 ),
                new TestIntParams( "2012-2", 2012, 2, 2012, 2, 1809864 ),
                new TestIntParams( "2012-3", 2012, 3, 2012, 3, 1809864 ),
                new TestIntParams( "2012-4", 2012, 4, 2012, 4, 1809864 ),
                new TestIntParams( "2012-5", 2012, 5, 2012, 5, 1809864 ),
                new TestIntParams( "2012-6", 2012, 6, 2012, 6, 1809864 ),
                new TestIntParams( "2012-7", 2012, 7, 2012, 7, 1809864 ),
                new TestIntParams( "2012-8", 2012, 8, 2012, 8, 1809864 ),
                new TestIntParams( "2012-9", 2012, 9, 2012, 9, 1809864 ),
                new TestIntParams( "2012-10", 2012, 10, 2012, 10, 1809864 ),
                new TestIntParams( "2012-11", 2012, 11, 2012, 11, 1809864 ),
                new TestIntParams( "2012-12", 2012, 12, 2012, 12, 1809864 ),
            }),
        ...
        public Service_Legalios_Example_01_Health_02_MaxAnnualsBasisTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //01_Health_02_MaxAnnualsBasis
            LogTestExamples("01_Health_02_MaxAnnualsBasis.txt", _tests);
#endif
        }
        [Theory]
        ...
        public void GetBundle_ShouldReturnValid_MaxAnnualsBasis(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
        {
            ...
            testResult.IfRight(r => r.HealthProps.MaxAnnualsBasis.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
