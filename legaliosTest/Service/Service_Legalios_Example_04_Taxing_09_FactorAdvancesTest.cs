...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_09_FactorAdvancesTest : Service_Legalios_Example_TaxingTest
    {
        ...
        public Service_Legalios_Example_04_Taxing_09_FactorAdvancesTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_09_FactorAdvances
            LogTestExamples("04_Taxing_09_FactorAdvances.txt", _tests);
#endif
        }
        [Theory]
        [MemberData(nameof(TestData))]
        public void GetBundle_ShouldReturnValid_FactorAdvances(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
        {
            ...
            testResult.IfRight(r => r.TaxingProps.FactorAdvances.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
