...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_12_FactorTaxRate2Test : Service_Legalios_Example_TaxingTest
    {
        ...
        private static readonly TestDecScenario[] _tests = new TestDecScenario[]
        {
            ...
            new TestDecScenario("2013", new TestDecParams[] {
                new TestDecParams( "2013-1", 2013, 1, 2013, 1, 0.0m),
                new TestDecParams( "2013-2", 2013, 2, 2013, 2, 0.0m),
                new TestDecParams( "2013-3", 2013, 3, 2013, 3, 0.0m),
                new TestDecParams( "2013-4", 2013, 4, 2013, 4, 0.0m),
                new TestDecParams( "2013-5", 2013, 5, 2013, 5, 0.0m),
                new TestDecParams( "2013-6", 2013, 6, 2013, 6, 0.0m),
                new TestDecParams( "2013-7", 2013, 7, 2013, 7, 0.0m),
                new TestDecParams( "2013-8", 2013, 8, 2013, 8, 0.0m),
                new TestDecParams( "2013-9", 2013, 9, 2013, 9, 0.0m),
                new TestDecParams( "2013-10", 2013, 10, 2013, 10, 0.0m),
                new TestDecParams( "2013-11", 2013, 11, 2013, 11, 0.0m),
                new TestDecParams( "2013-12", 2013, 12, 2013, 12, 0.0m),
            }),
            new TestDecScenario("2014", new TestDecParams[] {
                new TestDecParams( "2014-1", 2014, 1, 2014, 1, 0.0m),
                new TestDecParams( "2014-2", 2014, 2, 2014, 2, 0.0m),
                new TestDecParams( "2014-3", 2014, 3, 2014, 3, 0.0m),
                new TestDecParams( "2014-4", 2014, 4, 2014, 4, 0.0m),
                new TestDecParams( "2014-5", 2014, 5, 2014, 5, 0.0m),
                new TestDecParams( "2014-6", 2014, 6, 2014, 6, 0.0m),
                new TestDecParams( "2014-7", 2014, 7, 2014, 7, 0.0m),
                new TestDecParams( "2014-8", 2014, 8, 2014, 8, 0.0m),
                new TestDecParams( "2014-9", 2014, 9, 2014, 9, 0.0m),
                new TestDecParams( "2014-10", 2014, 10, 2014, 10, 0.0m),
                new TestDecParams( "2014-11", 2014, 11, 2014, 11, 0.0m),
                new TestDecParams( "2014-12", 2014, 12, 2014, 12, 0.0m),
            }),
            ...
            new TestDecScenario("2021", new TestDecParams[] {
                new TestDecParams( "2021-1", 2021, 1, 2021, 1, 23.0m),
                new TestDecParams( "2021-2", 2021, 2, 2021, 2, 23.0m),
                new TestDecParams( "2021-3", 2021, 3, 2021, 3, 23.0m),
                new TestDecParams( "2021-4", 2021, 4, 2021, 4, 23.0m),
                new TestDecParams( "2021-5", 2021, 5, 2021, 5, 23.0m),
                new TestDecParams( "2021-6", 2021, 6, 2021, 6, 23.0m),
                new TestDecParams( "2021-7", 2021, 7, 2021, 7, 23.0m),
                new TestDecParams( "2021-8", 2021, 8, 2021, 8, 23.0m),
                new TestDecParams( "2021-9", 2021, 9, 2021, 9, 23.0m),
                new TestDecParams( "2021-10", 2021, 10, 2021, 10, 23.0m),
                new TestDecParams( "2021-11", 2021, 11, 2021, 11, 23.0m),
                new TestDecParams( "2021-12", 2021, 12, 2021, 12, 23.0m),
            }),
            new TestDecScenario("2022", new TestDecParams[] {
                new TestDecParams( "2022-1", 2022, 1, 2022, 1, 23.0m),
                new TestDecParams( "2022-2", 2022, 2, 2022, 2, 23.0m),
                new TestDecParams( "2022-3", 2022, 3, 2022, 3, 23.0m),
                new TestDecParams( "2022-4", 2022, 4, 2022, 4, 23.0m),
                new TestDecParams( "2022-5", 2022, 5, 2022, 5, 23.0m),
                new TestDecParams( "2022-6", 2022, 6, 2022, 6, 23.0m),
                new TestDecParams( "2022-7", 2022, 7, 2022, 7, 23.0m),
                new TestDecParams( "2022-8", 2022, 8, 2022, 8, 23.0m),
                new TestDecParams( "2022-9", 2022, 9, 2022, 9, 23.0m),
                new TestDecParams( "2022-10", 2022, 10, 2022, 10, 23.0m),
                new TestDecParams( "2022-11", 2022, 11, 2022, 11, 23.0m),
                new TestDecParams( "2022-12", 2022, 12, 2022, 12, 23.0m),
            }),
        };
        public static IEnumerable<object[]> TestData => GetTestDecData(_tests);
        public Service_Legalios_Example_04_Taxing_12_FactorTaxRate2Test()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_11_FactorSolidary
            LogTestExamples("04_Taxing_12_FactorTaxRate2.txt", _tests);
#endif
        }
        [Theory]
        [MemberData(nameof(TestData))]
        public void GetBundle_ShouldReturnValid_FactorTaxRate2(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
        {
            ...
            testResult.IfRight(r => r.TaxingProps.FactorTaxRate2.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
