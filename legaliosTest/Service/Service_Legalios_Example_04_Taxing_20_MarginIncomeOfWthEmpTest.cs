...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_20_MarginIncomeOfWthEmpTest : Service_Legalios_Example_TaxingTest
    {
        ...
        private static readonly TestIntScenario[] _tests = new TestIntScenario[]
        {
            ...
            new TestIntScenario("2019", new TestIntParams[] {
                new TestIntParams( "2019-1", 2019, 1, 2019, 1, 2500 ),
                new TestIntParams( "2019-2", 2019, 2, 2019, 2, 2500 ),
                new TestIntParams( "2019-3", 2019, 3, 2019, 3, 2500 ),
                new TestIntParams( "2019-4", 2019, 4, 2019, 4, 2500 ),
        ...
        public Service_Legalios_Example_04_Taxing_20_MarginIncomeOfWthEmpTest()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_20_MarginIncomeOfWthEmp
            LogTestExamples("04_Taxing_20_MarginIncomeOfWthEmp.txt", _tests);
#endif
        }
        [Theory]
        [MemberData(nameof(TestData))]
        public void GetBundle_ShouldReturnValid_MarginIncomeOfWthEmp(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
        {
            ...
            testResult.IfRight(r => r.TaxingProps.MarginIncomeOfWthEmp.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
