...
namespace LegaliosTest.Service
{
    ...
    public class Service_Legalios_Example_04_Taxing_19_MarginIncomeOfTaxRate2Test : Service_Legalios_Example_TaxingTest
    {
        ...
        private static readonly TestIntScenario[] _tests = new TestIntScenario[]
        {
            ...
            new TestIntScenario("2021", new TestIntParams[] {
                new TestIntParams( "2021-1", 2021, 1, 2021, 1, 141764 ),
                new TestIntParams( "2021-2", 2021, 2, 2021, 2, 141764 ),
                new TestIntParams( "2021-3", 2021, 3, 2021, 3, 141764 ),
                new TestIntParams( "2021-4", 2021, 4, 2021, 4, 141764 ),
                new TestIntParams( "2021-5", 2021, 5, 2021, 5, 141764 ),
                new TestIntParams( "2021-6", 2021, 6, 2021, 6, 141764 ),
                new TestIntParams( "2021-7", 2021, 7, 2021, 7, 141764 ),
                new TestIntParams( "2021-8", 2021, 8, 2021, 8, 141764 ),
                new TestIntParams( "2021-9", 2021, 9, 2021, 9, 141764 ),
                new TestIntParams( "2021-10", 2021, 10, 2021, 10, 141764 ),
                new TestIntParams( "2021-11", 2021, 11, 2021, 11, 141764 ),
                new TestIntParams( "2021-12", 2021, 12, 2021, 12, 141764 ),
            }),
            new TestIntScenario("2022", new TestIntParams[] {
                new TestIntParams( "2022-1", 2022, 1, 2022, 1, 155644 ),
                new TestIntParams( "2022-2", 2022, 2, 2022, 2, 155644 ),
                new TestIntParams( "2022-3", 2022, 3, 2022, 3, 155644 ),
                new TestIntParams( "2022-4", 2022, 4, 2022, 4, 155644 ),
                new TestIntParams( "2022-5", 2022, 5, 2022, 5, 155644 ),
                new TestIntParams( "2022-6", 2022, 6, 2022, 6, 155644 ),
                new TestIntParams( "2022-7", 2022, 7, 2022, 7, 155644 ),
                new TestIntParams( "2022-8", 2022, 8, 2022, 8, 155644 ),
                new TestIntParams( "2022-9", 2022, 9, 2022, 9, 155644 ),
                new TestIntParams( "2022-10", 2022, 10, 2022, 10, 155644 ),
                new TestIntParams( "2022-11", 2022, 11, 2022, 11, 155644 ),
                new TestIntParams( "2022-12", 2022, 12, 2022, 12, 155644 ),
            }),
        };
        public static IEnumerable<object[]> TestData => GetTestIntData(_tests);
        public Service_Legalios_Example_04_Taxing_19_MarginIncomeOfTaxRate2Test()
        {
            _sut = new ServiceLegalios();
#if __PROTOKOL_TEST_FILE__
            //04_Taxing_19_MarginIncomeOfTaxRate2
            LogTestExamples("04_Taxing_19_MarginIncomeOfTaxRate2.txt", _tests);
#endif
        }
        [Theory]
        ...
        public void GetBundle_ShouldReturnValid_MarginIncomeOfSolidary(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
        {
            ...
            testResult.IfRight(r => r.TaxingProps.MarginIncomeOfTaxRate2.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
        }
    }
}
