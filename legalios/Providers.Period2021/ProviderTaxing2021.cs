...
{
    class ProviderTaxing2021 : ProviderBase, IProviderTaxing
    {
        public ProviderTaxing2021() : base(HistoryConstTaxing2021.VERSION_CODE)
        {
        }
        ...
        {
            return HistoryConstTaxing2021.FACTOR_SOLIDARY;
        }
        public decimal FactorTaxRate2(IPeriod period)
        {
            return HistoryConstTaxing2021.FACTOR_TAXRATE2;
        }
        ...
        {
            return HistoryConstTaxing2021.MARGIN_INCOME_OF_SOLIDARY;
        }
        public Int32 MarginIncomeOfTaxRate2(IPeriod period)
        {
            return HistoryConstTaxing2021.MARGIN_INCOME_OF_TAXRATE2;
        }
