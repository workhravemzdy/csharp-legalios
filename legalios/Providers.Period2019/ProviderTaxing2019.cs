...
{
    class ProviderTaxing2019 : ProviderBase, IProviderTaxing
    {
        public ProviderTaxing2019() : base(HistoryConstTaxing2019.VERSION_CODE)
        {
        }

        public IPropsTaxing GetProps(IPeriod period)
        {
            return new PropsTaxing2018(Version,
        ...
        {
            if (IsPeriodGreaterOrEqualThan(period, 2019, 5))
            {
